 ...
 */
export class RGBA extends ColourInterface {
  #r;
  #g;
  #b;
  #a;
...
export class CIEXYZA extends ColourInterface {
  #x;
  #y;
  #z;
  #a;
...
export class HSLA extends ColourInterface {
  #h;
  #s;
  #l;
  #a;
...
export class HSVA extends ColourInterface {
  #h;
  #s;
  #v;
  #a;
...
export class HSIA extends ColourInterface {
  #h;
  #s;
  #i;
  #a;
 ...
 */
export class Integer extends ColourInterface {
  #c;
  /**
  ...
  toString() {
    let x = "";
    let color = ((this.#c >>> 24) & 0xff).toString(16)
    x += chars("0", 2 - color.length) + color
    color = ((this.#c >>> 16) & 0xff).toString(16)
    x += chars("0", 2 - color.length) + color
    color = ((this.#c >>> 8) & 0xff).toString(16)
    x += chars("0", 2 - color.length) + color
    if(this.getAlpha() !== 1){
      color = (this.#c & 0xff).toString(16)
      x += chars("0", 2 - color.length) + color
    }
    return `#${x}`;
  }
...
//#region
export class NamedColour extends ColourInterface {
  #name;
  constructor(name) {
    super();
 ...
 */
export function shiftLeft(i, n = 1) {
  if (i === 0) return i;
  if (n > 32) return 0;
 ...
 */
export function shiftRight(i, n = 1) {
  if (i === 0 || n === 0) return i;
  if (n > 32) return 0;
 ...
 */
export const getBgColour = (element) => {
 ...
 * @returns {string} a css colour string
 */
export const getColour = (element) => {
  if (element.currentStyle) {
 ...
 */
export function sRGBtoLinearRGB(component) {
 ...
 */
export function sToLinearRGB(rgba) {
  return new RGBA(
 ...
 */
export function linearRGBTosRGB(component) {
 ...
 */
export function linearTosRGB(rgba) {
  return new RGBA(
 ...
 */
export function gammaCorrect(rgba) {
 ...
 */
export function gammaReCorrect(rgba) {
  const l = sToLinearRGB(rgba);
  return linearTosRGB(
    new RGBA(
 ...
 */
export function getGrayScale(rgb) {
  return linearTosRGB(
    new RGBA(
 ...
 */
export function blend(c1, c2, scale = 0.5, alpha = 1) {
 ...
 * second argument
 */
export function shade(rgb, scale = 0.2) {
 ...
 */
export function shadeHSL(hsl, scale = 0.1) {
  return new HSLA(
    hsl.getHue(),
    hsl.getSaturation(),
 ...
 * second argument
 */
export function tint(rgb, scale = 1) {
  // aka tint
 ...
 */
export function tintHSL(hsl, scale = 0.1) {
  return new HSLA(
    hsl.getHue(),
    hsl.getSaturation(),
    hsl.getLightness() + scale,
 ...
 * second argument
 */
export function tone(rgb, scale = 1) {
  return blend(
    rgb,
    new RGBA(
      Math.floor(0xff * 0.5),
 ...
 */
export function toneHSL(hsl, scale = 0.1) {
  return new HSLA(
    hsl.getHue(),
 ...
 */
export function colourise(src, dst) {
 ...
 */
export function harmonise(hsl, ...values) {
  if (
    !(
      hsl instanceof HSLA ||
      hsl instanceof HSVA ||
 ...
 */
export function analogous(hsl, angle, numOfColors = 1) {
 ...
 * of the array.
 */
export function complement(hsl) {
 ...
 * of the array.
 */
export function splitComplement(hsl, angle = (Math.PI / 2) / 2) {
 ...
 * of the array.
 */
export function twoTone(hsl, angle) {
 ...
 * of the array.
 */
export function offComplemetary(hsl, angle = (2 * Math.PI) / 3) {
  if (angle >= 0) {
    return [
      hsl,
 ...
 * of the array.
 */
export function doubleComplemetary(hsl, angle) {
 ...
 */
export function nColour(hsl, n, alphas = [], angle) {
 ...
 * @throws a `RangeError` if `n < 0` or if `alphas.length > 0 && alphas.length != n`
 */
export function colours(hsl, n, alphas = [], angle = Math.PI / 24) {
  if (n < 0) throw new RangeError("n was negative");
  if (alphas.length > 0 && alphas.length !== n) {
    throw new RangeError(
      "alphas does not have the required number of elements. Use an empty array for all opaque colours."
 ...
 */
export function* generateWheel(aspc = (2 * Math.PI) / 48) {
  // default 7.5deg
  if (aspc <= 0)
    throw new RangeError(
